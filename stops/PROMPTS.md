...
**Do not paste this whole file into ChatGPT.** It cannot attach the photographs
for you, and it will try to answer the document instead of doing the work. One
scene per chat.

When a section is done, start a **new chat** for the next one.
...
> 
> Say "ready" and I will send the first one.

### 1. Save the reply as `water__sh-fast.png`

> Edit this photograph. Keep the subject, the framing, the composition, the light, the colours and the crop exactly as they are. The camera has not moved and nothing in the scene has been rearranged.
> 
> Change one thing only: the shutter speed was very fast, so the falling water is frozen absolutely sharp, caught in a single instant. Every edge of it is crisp, with no motion blur anywhere in the frame. Same aspect ratio.

### 2. Save the reply as `water__sh-mid.png`
...
> Same photograph, same framing, same light, camera not moved.
> 
> This time the shutter was slow and the camera was on a tripod: the falling water is strongly blurred into smooth continuous streaks along its direction of travel, while everything stationary in the frame stays perfectly sharp. Same aspect ratio.
...
### 1. Save the reply as `kids__sh-fast.png`

> Edit this photograph. Keep the subject, the framing, the composition, the light, the colours and the crop exactly as they are. The camera has not moved and nothing in the scene has been rearranged.
> 
> Change one thing only: the shutter speed was very fast, so the running child and the dog is frozen absolutely sharp, caught in a single instant. Every edge of it is crisp, with no motion blur anywhere in the frame. Same aspect ratio.

### 2. Save the reply as `kids__sh-mid.png`
...
> Same photograph, same framing, same light, camera not moved.
> 
> This time the shutter was slow and the camera was on a tripod: the running child and the dog is strongly blurred into smooth continuous streaks along its direction of travel, while everything stationary in the frame stays perfectly sharp. Same aspect ratio.
...
### 1. Save the reply as `sports__sh-fast.png`

> Edit this photograph. Keep the subject, the framing, the composition, the light, the colours and the crop exactly as they are. The camera has not moved and nothing in the scene has been rearranged.
> 
> Change one thing only: the shutter speed was very fast, so the player and the ball is frozen absolutely sharp, caught in a single instant. Every edge of it is crisp, with no motion blur anywhere in the frame. Same aspect ratio.

### 2. Save the reply as `sports__sh-mid.png`
...
> Same photograph, same framing, same light, camera not moved.
> 
> This time the shutter was slow and the camera was on a tripod: the player and the ball is strongly blurred into smooth continuous streaks along its direction of travel, while everything stationary in the frame stays perfectly sharp. Same aspect ratio.
...
### 1. Save the reply as `nightcity__sh-fast.png`

> Edit this photograph. Keep the subject, the framing, the composition, the light, the colours and the crop exactly as they are. The camera has not moved and nothing in the scene has been rearranged.
> 
> Change one thing only: the shutter speed was very fast, so the cars and their headlights is frozen absolutely sharp, caught in a single instant. Every edge of it is crisp, with no motion blur anywhere in the frame. Same aspect ratio.

### 2. Save the reply as `nightcity__sh-mid.png`
...
> Same photograph, same framing, same light, camera not moved.
> 
> This time the shutter was slow and the camera was on a tripod: the cars and their headlights is strongly blurred into smooth continuous streaks along its direction of travel, while everything stationary in the frame stays perfectly sharp. Same aspect ratio.
...
### 1. Save the reply as `panning__sh-fast.png`
...
### 1. Save the reply as `group__ap-wide.png`
...
### 1. Save the reply as `food__ap-wide.png`
...
### 1. Save the reply as `indoor__ap-wide.png`
...
### 1. Save the reply as `street__ap-wide.png`
...
### 1. Save the reply as `street__fl-wide.png`

> Edit this photograph. Same scene, same light, same time of day, same mood.
> 
...
### 3. Save the reply as `street__fl-long.png`
...
### 1. Save the reply as `landscape__fl-wide.png`
...
```
cp stops/photos/landscape.jpg ~/stops-v2/landscape__fl-norm.jpg
```

### 3. Save the reply as `landscape__fl-long.png`
...
### 1. Save the reply as `architecture__fl-wide.png`
...
```
cp stops/photos/architecture.jpg ~/stops-v2/architecture__fl-norm.jpg
```

### 3. Save the reply as `architecture__fl-long.png`
...
**33 images to generate**, plus 3 copies. Zip them all into one folder and send the zip.
